...
public class moorePayApp {
	...
	//System.out.println("\n             Deductions: ");
        System.out.println("\nFederal Witholding: $" + String.format("%.2f", (federalWithholdRate = grossPay * federalTaxRate)));
	System.out.println("State Witholding: $" + String.format("%.2f", (stateWithholdRate = grossPay * stateTaxRate)));
