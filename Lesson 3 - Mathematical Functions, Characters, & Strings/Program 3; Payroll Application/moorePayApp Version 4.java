...
public class moorePayApp {
	...
	//System.out.println("\n             Deductions: ");
        System.out.println("\nFederal Witholding (%.1f%%): $%.2f" + String.format("%.2f", (federalWithholdRate = grossPay * federalTaxRate)));
	System.out.println("State Witholding (%.1f%%): $%.2f" + String.format("%.2f", (stateWithholdRate = grossPay * stateTaxRate)));
